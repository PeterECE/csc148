...
class FourInARow:
    ...
    Attributes:
    - n: Size of the grid
    - p1_human: Indicates whether Player 1 is a human or computer
    - p2_human: Indicates whether Player 2 is a human or computer
    - result: Stores the current status of game
    - board : game board
    - p1_to_play: To check which turns is
...
def load_game() -> FourInARow:  # pragma: no cover
    ...
    True
    """
    input_string = input("Enter game parameters"
                         " (<n> <is_p1_human?> "
                         "<is_p2_human?>):\n")
